...
const Navbar = () => {
    ...
    function activeSection(path: any) {
        if (path === 'home') {
            ...
            setIsMethodology(false)
            setIsTechnologies(false)
        } else if (path === 'ArchitectureDiagram') {
            setIsHome(false)
            setIsProjectScope(true)
            setIsmilestones(false)
            setIsDownloads(false)
            ...
            <div className="container-fluid">
                <div className="navbar-heading mt-2">
                    <h3 style={{ marginLeft: '30px' }}>
                        <Link className="navbar-h ms-5" to="/" style={{color: '#957bda'}}>
                            <img src="https://github.com/chamod-ishankha/childy-app-contents/blob/master/images/application_icon-removebg-preview.png?raw=true" style={{ height: '80px' }} alt="Logo" className="logo-image me-3" />
                            CHILDY
                        </Link>
                    </h3>
                </div>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav  mb-2 mb-lg-0 ms-auto" style={{ marginRight: '2%' }}>
                        <li className="nav-item">
                            <a onClick={() => { activeSection("home") }} className={`nav-link nav-link-a-text me-3 ${isHome ? 'active' : 'text-color-purple'}`} aria-current="page" href="#home">Home</a>
                        </li>
                        <li className="nav-item dropdown" onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
                            <a
                                className={` nav-link nav-link-a-text me-3 dropdown-toggle ${isProjectScope ? 'active' : 'text-color-purple'}`}
                                type="button"
                                role="button"
                            ...
                            <ul className={`dropdown-menu${isDropdownOpen ? ' show' : ''}`} aria-labelledby="projectScopeDropdown">
                                <li>
                                    <a
                                        className={`dropdown-item ${isLitrivew ? 'active' : 'text-color-purple'}`}
                                        href="#Literature"
                                ...
                                <li>
                                    <a
                                        className={`dropdown-item ${isresearchGap ? 'active' : 'text-color-purple'}`}
                                        href="#researchgap"
                                ...
                                <li>
                                    <a
                                        className={`dropdown-item ${isProblem ? 'active' : 'text-color-purple'}`}
                                        href="#Problem"
                                ...
                                <li>
                                    <a
                                        className={`dropdown-item ${isObjectives ? 'active' : 'text-color-purple'}`}
                                        href="#Objectives"
                                ...
                                <li>
                                    <a
                                        className={`dropdown-item ${isMethodology ? 'active' : 'text-color-purple'}`}
                                        href="#ArchitectureDiagram"
                                        onClick={() => { activeSection("ArchitectureDiagram") }}
                                    >
                                ...
                                <li>
                                    <a
                                        className={`dropdown-item ${isTechnologies ? 'active' : 'text-color-purple'}`}
                                        href="#Technologies"
                        ...
                        <li className="nav-item">
                            <a onClick={() => { activeSection("milestones") }} href='#milestones' className={`nav-link me-3 nav-link-a-text ${ismilestones ? 'active' : 'text-color-purple'}`}>Milestones</a>
                        </li>

                        <li className="nav-item dropdown" onClick={() => setIsDownloadDropdownOpen(!isDownloadDropdownOpen)}>
                            <a
                                className={` nav-link nav-link-a-text me-3 dropdown-toggle ${isDownloads ? 'active' : 'text-color-purple'}`}
                                type="button"
                                role="button"
                                id="downLoadDropdown"
                                data-toggle="dropdown"
                            ...
                            <ul className={`dropdown-menu${isDownloadDropdownOpen ? ' show' : ''}`} aria-labelledby="downLoadDropdown">
                                <li>
                                    <a
                                        className={`dropdown-item ${isDocuments ? 'active' : 'text-color-purple'}`}
                                        href="#Documents"
                                ...
                                <li>
                                    <a
                                        className={`dropdown-item ${isPresentations ? 'active' : 'text-color-purple'}`}
                                        href="#Presentations"
                        ...
                        <li className="nav-item">
                            <a onClick={() => { activeSection("aboutus") }} className={`nav-link nav-link-a-text me-3 ${isAboutUs ? 'active' : 'text-color-purple'}`} href="#aboutus" >About Us</a>
                        </li>
                        <li className="nav-item">
                            <a onClick={() => { activeSection("ContactUs") }} className={`nav-link nav-link-a-text me-3 ${isContactUs ? 'active' : 'text-color-purple'}`} href="#ContactUs" >Contact Us</a>
                        </li>
                    </ul>
                </div>
            </div>
